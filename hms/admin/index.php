...
if(isset($_POST['submit']))
{
    ...
    // Perbaikan query dengan mysqli_num_rows
...
<head>
    ...
    <title>Login Admin | Lapas Lubuk Linggau</title>
    ...
    <style>
        ...
        * {
        ...
        .logo-container img {
            height: 50px;
            width: auto;
            /* Hapus filter yang membuat logo jadi putih */
            animation: pulse 2s ease-in-out infinite;
            /* Tambahkan background putih untuk kontras */
            background: white;
            padding: 5px;
            border-radius: 8px;
        }
        ...
        /* Tambahkan padding khusus untuk input password */
        input[type="password"],
        ...
        <div class="login-card">
            ...
            <div class="login-body">
                <div class="welcome-text">
                    ...
                    <p>Akses khusus untuk pengelola sistem</p>
                </div>
